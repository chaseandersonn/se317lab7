...
public class CalculatorTestDev {
        ...
        **/
        ...
        public void testSquared() throws InterruptedException {
            ...
            Thread.sleep(2300);
//            window.textBox("screen").requireText("64.0");
            String actualText = window.textBox("screen").text();
            assertTrue(actualText.equals("64.0") || actualText.equals("64"));
        ...
        public void testSquareRoot() throws InterruptedException {
            ...
            Thread.sleep(2300);
           // System.out.println(window.textBox("screen"));
            //window.textBox("screen").requireText("6.0");
            String actualText = window.textBox("screen").text();
            assertTrue(actualText.equals("6.0") || actualText.equals("6"));
